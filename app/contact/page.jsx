...
import { Phone, Mail, MapPin, Send, Instagram, Youtube, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  return (
    <>
      ...
      <section 
        ...
        style={{ 
          backgroundImage: "url('https://images.pexels.com/photos/6770609/pexels-photo-6770609.jpeg')",
          ...
          >
            <MotionDiv variants={fadeInUp}>
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed">
                Ready to start your trading journey? Have questions about our programs? 
                Our expert mentors are here to help you succeed.
              </p>
            </MotionDiv>
          </MotionDiv>
        </Container>
        ...
        <Container>
          ...
          >
            ...
            <p className="text-xl mb-8 text-white/80">
              Limited seats available in our next batch. Don't miss this opportunity!
            </p>
            ...
            >
              ...
              <div className="space-y-8 mb-12">
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-black mb-2">Phone & WhatsApp</h3>
                    <p className="text-lg text-black/70 mb-1">{siteConfig.contact.phone}</p>
                    <p className="text-sm text-black/60">WhatsApp: {siteConfig.contact.whatsapp}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-black/70">{siteConfig.contact.email}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-black mb-2">Office Address</h3>
                    <p className="text-lg text-black/70 leading-relaxed">{siteConfig.contact.address}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/5 backdrop-blur-sm border border-black/10 rounded-3xl p-10">
                ...
                <form ref={form} onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="interested" className="ml-3 text-sm text-black/70">
        ...
        <Container>
          ...
          >
            ...
            <p className="text-xl text-black/70 max-w-2xl mx-auto">
              Come meet our team in person and get a feel for our learning environment.
            </p>
          </MotionDiv>
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.6947424089024!2d72.8856043!3d19.0759837!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c9f1e6d23d7b%3A0x5d8b8c5d8b8c5d8b!2sMumbai%2C%20Maharashtra%2C%20India!5e0!3m2!1sen!2sus!4v1635789012345!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
