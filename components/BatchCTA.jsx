...
export default function BatchCTA() {
  return (
    <Section className="bg-white text-black relative overflow-hidden border">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_black_1px,_transparent_1px)] bg-[length:30px_30px]"></div>
      </div>
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <MotionDiv variants={fadeInUp} className="space-y-8">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-black/10 rounded-full text-sm font-medium">
                ...
                <h2 className="text-4xl md:text-5xl font-bold leading-tight text-black">
                  New Batch Starting
                  <span className="block text-black/70">August 15, 2025</span>
                </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-black/5 border border-black/10 rounded-2xl p-4 hover:bg-black/10 transition-colors">
                ...
                <div className="bg-black/5 border border-black/10 rounded-2xl p-4 hover:bg-black/10 transition-colors">
                  ...
                  <div className="font-semibold text-black">Max 25 Students</div>
                </div>
                
                <div className="bg-black/5 border border-black/10 rounded-2xl p-4 hover:bg-black/10 transition-colors">
                  <MapPin className="w-6 h-6 mb-3 text-black/70" />
                  <div className="text-sm text-black/60">Mode</div>
                  <div className="font-semibold text-black">Online + Offline</div>
                </div>
              </div>
            </MotionDiv>
            ...
            <MotionDiv variants={fadeInUp} className="space-y-8">
              <div className="bg-black/5 backdrop-blur-sm border border-black/10 rounded-3xl p-8">
                ...
                <div className="space-y-4">
                  {/* Phone CTA */}
                  <div className="group bg-black text-white rounded-2xl p-6 hover:bg-black/90 transition-all duration-300 cursor-pointer">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-white/80">+91 9927586879</div>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-white/80">Get instant response</div>
                        </div>
                      </div>
                      <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                    </div>
                  ...
                  {/* Contact Page CTA */}
                  <Link href="/contact">
                    <div className="group border border-black/20 text-black rounded-2xl p-6 hover:bg-black/5 hover:border-black/40 transition-all duration-300 cursor-pointer">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-black/70">View full contact details</div>
                          </div>
                        </div>
                        <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                      </div>
          ...
          >
            <div className="text-center max-w-3xl mx-auto">
              <blockquote className="text-xl md:text-2xl font-light italic text-black/80 mb-6">
                "This program changed my financial future. The mentors are exceptional and 
                the practical approach makes all the difference."
              </blockquote>
              <div className="flex items-center justify-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-black/60">Batch 2024 Graduate</div>
                </div>
              </div>
            </div>
          </MotionDiv>
